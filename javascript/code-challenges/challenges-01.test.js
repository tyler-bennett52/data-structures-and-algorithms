...
const addOne = (arr) => {
  const tempArray = [];
  arr.forEach(element => tempArray.push(element+1));
  return tempArray;
};
...
const addExclamation = (arr) => {
  const tempArray = [];
  arr.forEach(string => tempArray.push(string + '!'));
  return tempArray;
};
...
const allUpperCase = (arr) => {
  const tempArray = [];
  arr.forEach(string => tempArray.push(string.toUpperCase()));
  return tempArray;
};
...
const speaker = (words, callback) => {
  const tempArray = [];
  words.forEach(word => tempArray.push(callback(word)));
  return tempArray;
};
