...
const sortByChildren = (charArray) => {
  const alphabeticalSort = charArray.sort((a,b) => a > b ? 1 : -1);
  return alphabeticalSort.sort((a, b) => a.children.length - b.children.length);
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const containsW = (str) => {
  const dubs = new RegExp(/w/);
  return dubs.test(str);
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const isNum = (input) => /[123456789]/.test(input);
...
const isCapitalized = (str) => {
  const titleCase = new RegExp(/[A-Z][a-z]*/g);
  if (str.match(titleCase)) {
    return str.match(titleCase);
  }
  return [];
};
/* ------------------------------------------------------------------------------------------------
